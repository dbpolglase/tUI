...
que se podrán representar los siguientes componentes o elementos:</p>
<ul>
...
<li>nombreProyecto_func.h, con los prototipos de las funciones de<br>
...
<p>O podemos utilizar el interfaz gráfico suministrado, al menos en esta etapa inicial en la que no hay funciones de callback de usuario:</p>
<ul>
<li>Copia al directorio de trabajo el fichero makefile_tui que se<br>
localiza en /usr/include/tui.</li>
<li>Ejecuta Make-&gt;compile y responde OK a Rewrite Functions File ya que<br>
no hemos generado anteriormente.</li>
<li>Se procede a crear un directorio con el nombre del proyecto y a<br>
compilar el mismo mediante este makefile  (makefile_tui ) el cual<br>
ejecuta el tbuild, la compilación y el montaje.</li>
</ul>
<blockquote>
<p>Dependiendo de la instalación realizada es posible que debas ajustar algún dato del makefile_tui como la ubicación del tbuild o las  librerias y headers.</p>
</blockquote>
...
<p>El ultimo ajuste que vamos ha hacer es la navegación en el boton1 de menu1  Moves indicamos para el evento Enter nivel2:boton1.</p>
<blockquote>
...
<p>De forma análoga podemos definir menús de cualquier nivel de profundidad y complejidad.</p>
