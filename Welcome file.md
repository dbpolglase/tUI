...
El botón izquierdo se traducirá:</p>
</li>
<li>
<p>En caso de pulsación sobre el elemento activo, si este es un componente de un panel  en un evento “enter” sobre el mismo, si la vista es una tabla en la selección del registro marcado y si es una vista edit en el posicionamiento del cursor en esa posición.</p>
</li>
<li>
<p>En el caso de  pulsar sobre otra vista y/o elemento de las que se<br>
muestran en la navegación hasta la misma es decir la activación de<br>
esa vista/elemento.</p>
<p>La pulsación del botón derecho resultará en un evento out  de forma general.<br>
El botón central se traducirá como Up/Dw en las vistas de tabla y edición.</p>
</li>
</ul>
<h1 id="empezando">Empezando</h1>
<p>A continuación se describirá las nociones iniciales a considerar antes de comenzar a realizar una aplicación utilizando tUI.<br>
La forma mas sencilla es  explicar  los puntos descritos en el aparatado General del  interfaz gráfico de usuario tui para lo cual arracamos el mismo con el comando tUI.</p>
...
Al inicializar el bloque de color se indicara si se admite el uso de color o no.</p>
...
<p>Estos colores o estilos se definirán:<br>
...
<p>Las ventanas de aviso quedarán como las únicas activas bloqueando la aplicación hasta su cierre.</p>
</blockquote>
<h1 id="paneles-primera-aplicación">PANELES, PRIMERA APLICACIÓN</h1>
...
<blockquote>
<p>El titulo aparece en el marco del panel por lo que será necesario indicar border si queremos dar un titulo al panel.</p>
</blockquote>
...
<blockquote>
<p>Cuando el evento no esta capturado por el componente activo la<br>
aplicación comprobará si el evento esta capturado por la vista activa<br>
y de ser así procederá a ejecutar lo que indica la vista en este caso hemos utilizado la vista con nombre clave exit que indica finalizar aplicación.</p>
</blockquote>
<blockquote>
...
Ch. Ed: . es el  carácter a mostrar en las posiciones no rellenas del campo.<br>
...
opciones: NORMAL, visible y seleccionable. HIDDEN oculto, NOT<br>
SELECTABLE, no seleccionable y  OPEN las opciones solo se visualizan y<br>
se pueden seleccionar al pulsar sobre el botón, requiere programación<br>
por el usuario para una vez seleccionado un valor mostrarlo en<br>
pantalla.</p>
</blockquote>
...
<p>Y ya solo nos queda un elemento que es el botón que ya hemos visto con los menus así que añadiremos simplemente un botón del tipo:</p>
<p>Id:4<br>
Name: done<br>
Color: colorMenu<br>
Border:Y<br>
...
<p>En la vista menu1 / boton2 vamos a aplicar en Application Moves form1:name para el evento Enter:</p>
...
Down, “:2”</p>
<blockquote>
<p>Podremos navegar con la tecla Tab o con la tecla Down al siguiente<br>
elemento del formulario.</p>
</blockquote>
<p>Previous, “:4”<br>
Up, “:4”</p>
<blockquote>
<p>Con la tecla SHIFT-TAB o con la tela Up iremos al último elemento<br>
del formulario el botón.</p>
</blockquote>
...
<p>Todo lo anterior esta muy bien, podemos crear menus y formularios pero algo habrá que hacer con ellos.<br>
...
<blockquote>
<p>trAction* madeForm (tComponent * component,int key){ static trAction<br>
action;  initAction(action); return &amp;action; }</p>
</blockquote>
<p>Esto compone el prototipo de la función que deberemos rellenar con nuestra lógica, Recibe como parámetros la pulsación que ha provocado el evento y el componente que ha capturado el mismo, esto<br>
nos permite por ejemplo utilizar una misma función en distintos lugares de nuestro interfaz.</p>
...
<h3 id="optomade-y-componentnext">opToMade y componentNext</h3>
...
<p>Otra cosa que podemos hacer es es cambiar el MSG es:</p>
<pre><code>  if (fd == NULL){
...
<p>El cualquier formulario es habitual tener que cargar datos, algunos serán por defecto y otros no.<br>
...
<p>En la vista List-&gt;Calls no debe aparecer la nueva función definida.</p>
