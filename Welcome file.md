...
<li>
<p>El segundo elemento es un compilador (<em><strong>tbuild</strong></em>) que traduce la descripción de un interfaz de usuario descrito en formato xml en llamadas a la librería libtui y construir  una aplicación completa y funcional.</p>
</li>
<li>
